...
const tools = [
  ...
  {
    id: "mobile-tablet-tester",
    name: "Mobile & Tablet Tester",
    description:
      "Preview and test websites on mobile and tablet devices in real-time",
    href: "/mobile-tablet-tester",
    icon: Monitor,
    category: "analysis",
    estimatedTime: "Instant",
    tags: ["mobile", "tablet", "responsive", "preview", "testing"],
  },
];
